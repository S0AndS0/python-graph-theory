...
When you're ready I've begun covering one way of constructing a [`Graph`][graphs] class that enables moving more than one `Agent` at a time.
...
{% capture graph_series %}{%- post_url 2019-04-07-graph-00 -%}{% endcapture %}
